...
export default function Hometop() {
  ...
  const svgs = [
    ...
    {
      url: SVGS.hstat,
      tag: 'Store and analyse the stats based on your rules !',
    },
    {url: SVGS.hcustom, tag: 'Tight protection !'},
    {
      url: SVGS.hshare,
      tag: 'See realtime updates anywhere anytime with full control !',
    },
  ];
    ...
    return (
      <li key={`${src.url}`}>
        <div className="row mt-2">
          ...
          <div className="col-10">{src.tag}</div>
        </div>
      </li>
    );
  };
              ...
              <div className="row">
                ...
                <div className="col-10">
                  <h1 style={{fontWeight: '300'}}>
                    Create a game auction instantly !
                  </h1>
                </div>
              </div>
            </div>
