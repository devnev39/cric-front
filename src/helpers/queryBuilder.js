function pushreturnwrapper(obj,Qobj){
    obj.queries.push(Qobj);
    return obj;
}

export default function queryBuiler(){
    this.queries = [];
    this.group = (qobj) => {return pushreturnwrapper(this,{$group : qobj})}
    this.match = (qobj) => {return pushreturnwrapper(this,{$match : qobj})}
